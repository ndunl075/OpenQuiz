    ...
    <label className="block w-full">
      <input
        className={clsx(
          ...
          'placeholder:text-[var(--oq-text-faint)] focus:border-indigo-oq',
          className,
        )}
        {...rest}
      />
      {caption && (
        <span className="mt-1.5 block text-[11px] font-semibold uppercase tracking-wider text-[var(--oq-text-faint)] peer-focus:text-indigo-oq">
          {caption}
        </span>
      )}
    </label>
